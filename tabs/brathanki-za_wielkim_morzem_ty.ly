...
Śniegu pytam: "Gdzieżeś Ty?" \textbf{C H7 e}\\
Już szczebiocze ptak, już wiosna i bzy \textbf{e D}\\
Nocą gwiazdy złote tak jak kaczeńce \textbf{e D}\\
Gwiazdek pytam: "Gdzieżeś Ty?" \textbf{C H7 e}\\
\\
\textbf{H7 e6+ H7 e6+}\\
\\
